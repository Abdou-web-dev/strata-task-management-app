...
const AuthForm: React.FC<AuthFormProps> = ({ onSubmit, isSignUp, error }) => {
  ...
  const inputWrapperClassName = `${
    formikAuthForm.errors.username || formikAuthForm.errors.email || formikAuthForm.errors.password ? "" : "mb-4"
